...
//                   Dedicated (Ayu)physician and surgeon with extensive training in traditional Indian medicine, 
//                   specializing in cardiovascular diseases and gynecological care & Emergency medical service. Committed to providing holistic 
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Cards Section */}
          {/* ... existing cards code remains unchanged ... */}
          {/* You can paste the rest of your original code here without modifying anything else */}
